...
class AIAgent:
    ...
    def generate_answer(self, question_text: str, subject_name: str = "") -> str:
        """Генерирует развёрнутый ответ (Mock или реальный)"""
        
        # Если ключа нет — возвращаем Mock-ответ
        ...
        try:
            ...
            user_prompt = f"Предмет: {subject_name}\nВопрос: {question_text}\n\nДай развёрнутый ответ для подготовки к экзамену:"
